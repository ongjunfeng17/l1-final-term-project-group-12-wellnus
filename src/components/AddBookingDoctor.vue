...
export default {
    ...
    methods: {
        ...
        async savetofs() {
            ...
            const { selectedTime, teleconsult, needMC, reasonForVisit, email, user } = this;
            const selectedDate = this.selectedDate.split(' ')[0];
            
            if (!selectedDate || !selectedTime || !teleconsult || !needMC || !reasonForVisit || !email) {
                    ...
                    <v-card-text class="pa-1">
                        <v-row align="center" justify="center">
                            <v-col cols="12" sm="8">
                                ...
                                <v-text-field v-model="email" label="Patient Email" outlined dense
